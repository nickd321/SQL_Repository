...
-- Description:	Cameron I Stepped It Up With My Execs Challenge
...
--				Added Challenge ID for non-Fitbit Challenge
--
-- =============================================

CREATE PROCEDURE [cameron].[proc_Challenge_StepItUpWithMyExecs]
AS
BEGIN
	SET NOCOUNT ON;
...
LEFT JOIN
	...
	ON  (trk.TrackerEntryID = 39)
		...
		AND	(chlg.ClientChallengeID IN (1235,1265))
LEFT JOIN
	(
	SELECT
