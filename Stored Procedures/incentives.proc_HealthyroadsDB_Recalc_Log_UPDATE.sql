...
CREATE PROCEDURE [incentives].[proc_HealthyroadsDB_Recalc_Log_UPDATE] 
	@inLogID INT,
	@inRecalculated BIT,
...
BEGIN
	...
	UPDATE DA_Reports.incentives.HealthyroadsDB_Recalc_Log
	SET
...
GO
GRANT EXECUTE ON  [incentives].[proc_HealthyroadsDB_Recalc_Log_UPDATE] TO [Incentive_User]
GO
