...
-- Description:	Providence Incentives Data for HRA
--
-- Notes:		
--
-- Updates:		WilliamPe 20131231
--				Added logic to exclude primary and spouses where the CS1 values do not match
--
--				WilliamPe 20140108
--				Updated ReportedTo to 'HealthEquity_HRA'
--
--				WilliamPe 20140205
...
CREATE PROCEDURE [providence].[proc_Incentives_HRA] 
...
BEGIN
	...
	EXEC [providence].[proc_Incentives_BaseData] 'HRA',1
	...
	SELECT
		...
		'HealthEquity_HRA' AS ReportedTo,
	...
	JOIN
		...
		AND	(earn.ReportedTo = 'HealthEquity_HRA')
	LEFT JOIN
