...
CREATE PROCEDURE [incentives].[proc_IncentiveDB_Recalc_Log_READ] 
...
BEGIN
	...
	SELECT
		...
		AddedBy
	FROM
		DA_Reports.incentives.IncentiveDB_Recalc_Log WITH (NOLOCK)
	WHERE
...
GO
GRANT EXECUTE ON  [incentives].[proc_IncentiveDB_Recalc_Log_READ] TO [Incentive_User]
GO
